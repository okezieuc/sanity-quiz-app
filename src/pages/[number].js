...
const Option = ({ action, option, }) => <Box as="button" onClick={action}>
	<Box px="4" py="2" fontSize="xl" fontWeight="semibold" color="white" bg="blue.400" w="max-content" borderRadius="8" mx="auto">
	{option}
	</Box>
...
const Index = ({ questiondata }) => {
  ...
  <Box  width="1200px" mx="auto">
    <Box mx="auto" minH="120px">
		...
		<Box maxW="40" borderTop="1px solid" borderColor="gray.400" my="8" mx="auto">
		</Box>
        ...
        <ModalContent>
          ...
          <ModalFooter>
						...
						<Box bg="blue.500" color="white" borderRadius="4" px="4" py="2" _hover={{background: "blue.400"}} mr={3} onClick={onClose}>
              <Link href="/">
							Proceed
